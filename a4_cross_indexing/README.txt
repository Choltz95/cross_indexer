...
We were not required to write a c compiler for this project. To achieve our goals, we made use of gcc’s g3 tag to generate a DWARF symbol table and parse the table, we used the external program dwarfdump to extract various information. 
